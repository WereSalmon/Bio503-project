...
Comparing the different functions present in our samples there is evidence for the presence of aerobic chemoheterotrophy across sites and samples. There is also some evidence for the presence of dark sulfur oxidation, oxygenic photoautotrophy, fermentation, and predation/parasitism (predatory_or_exoparasitic) at low levels in some cases. We can check this by running a single sample t-test, comparing the frequency of each of these traits to 0. To do this test we will group our data by the kelp and region where the sample was collected.
...
write.table(sig_vals,"kelpme_mainfuncs_presence.txt", quote = FALSE, sep = ",")
print(sig_vals)
```

From this we can see that all of these traits are present in at least some samples, giving us an preliminary functional profile for our microbiomes.
...
write.table(sig_vals,"kelpme_mainfuncs_kelp.txt", quote = FALSE, sep = ",")
print(sig_vals)
```
...
write.table(sig_vals,"kelpme_mainfuncs_region.txt", quote = FALSE, sep = ",")
print(sig_vals)
```
...
To analyze these functions we will first summarize their relative abundance data.
...
This gives the relevant taxa plots:

<img src = "figures/taxaplots/Taxa assigned trait aerobic chemoheterotrophy.png" alt = "image" width = 450 height = auto> <img src = "figures/taxaplots/Taxa assigned trait dark sulfur oxidation.png" alt = "image" width = 450 height = auto> <img src = "figures/taxaplots/Taxa assigned trait oxygenic photoautotrophy.png" alt = "image" width = 450 height = auto> <img src = "figures/taxaplots/Taxa assigned trait fermentation.png" alt = "image" width = 450 height = auto> <img src = "figures/taxaplots/Taxa assigned trait predatory or exoparasitic.png" alt = "image" width = 450 height = auto> 